...
class Converter(QtGui.QWidget):
    ...
    def create_data_input(self):
        ...
        self.bitfield.textChanged[str].connect(self.onChanged)
        ...
        self.bytesfield.textChanged[str].connect(self.onChanged)
        ...
        self.KBfield.textChanged[str].connect(self.onChanged)
        ...
        self.MBfield.textChanged[str].connect(self.onChanged)
        ...
        self.GBfield.textChanged[str].connect(self.onChanged)
        ...
        self.TBfield.textChanged[str].connect(self.onChanged)
        ...
        self.PBfield.textChanged[str].connect(self.onChanged)
        ...
        self.KiBfield.textChanged[str].connect(self.onChanged)
        ...
        self.MiBfield.textChanged[str].connect(self.onChanged)
        ...
        self.GiBfield.textChanged[str].connect(self.onChanged)
        ...
        self.TiBfield.textChanged[str].connect(self.onChanged)
        ...
        self.PiBfield.textChanged[str].connect(self.onChanged)
